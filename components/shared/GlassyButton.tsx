  ...
  return (
    <motion.button
      ...
      className={cn(
        ...
        "text-gray-900 group-hover:text-iceblue-500 transition-colors duration-300",
    ...
    >
      ...
      <motion.div
        className="absolute inset-0 bg-gradient-to-br from-iceblue-300/0 via-iceblue-200/0 to-iceblue-300/0 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300 blur-xl -z-10"
        initial={false}
      />
      
      {/* Glossy light blue overlay on hover */}
      <motion.div
        className="absolute inset-0 bg-gradient-to-br from-iceblue-200/0 via-iceblue-100/0 to-iceblue-200/0 rounded-full opacity-0 group-hover:opacity-30 transition-opacity duration-300 -z-10"
        initial={false}
      />
      
      {/* Content with glossy text effect */}
      <span className="relative z-10 flex items-center justify-center transition-all duration-300 group-hover:drop-shadow-[0_0_8px_rgba(106,173,255,0.5)]">
        {children}
      </span>
    </motion.button>
  );
