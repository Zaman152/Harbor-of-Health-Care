          ...
          >
            <div className="space-y-6">
              <motion.h1
                ...
                className="mb-1 pb-1.5 font-heading text-4xl md:text-5xl lg:text-6xl font-bold leading-tight text-center lg:text-left bg-gradient-to-r from-pink-500 via-pink-400 to-pink-300 bg-clip-text text-transparent"
              >
